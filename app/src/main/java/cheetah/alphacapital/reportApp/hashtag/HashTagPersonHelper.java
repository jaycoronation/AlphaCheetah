package cheetah.alphacapital.reportApp.hashtag;
 ...
 *
 */
public final class HashTagPersonHelper implements ClickableForegroundColorSpan.OnHashTagClickListener {
    ...
    public static final class Creator{
        ...
        public static HashTagPersonHelper create(int color, OnHashTagClickListener listener){
            return new HashTagPersonHelper(color, listener, null);
        }

        public static HashTagPersonHelper create(int color, OnHashTagClickListener listener, char... additionalHashTagChars){
            return new HashTagPersonHelper(color, listener, additionalHashTagChars);
        }
    ...
    private HashTagPersonHelper(int color, OnHashTagClickListener listener, char... additionalHashTagCharacters) {
