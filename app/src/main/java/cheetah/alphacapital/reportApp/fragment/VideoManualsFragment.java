...
import cheetah.alphacapital.databinding.FragmentVideoManualsBinding;
...
public class VideoManualsFragment extends Fragment
{
    private FragmentVideoManualsBinding binding;
    ...
    public VideoManualsFragment(String id)
    {
        this.modualId = id;
    }
    ...
    {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_video_manuals, container, false);
