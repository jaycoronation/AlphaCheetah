...
import cheetah.alphacapital.databinding.FragmentBusinessToolBinding;
...
public class BusinessToolFragment extends Fragment
{
    private FragmentBusinessToolBinding binding;
    private String modualId = "";
    private FragmentActivity activity;
    private SessionManager sessionManager;
    public ApiInterface apiService;
    private final ArrayList<AllLearningManualResponseModel.DataItem> listData = new ArrayList<>();
    private DataAdapter viewAdapter;

    public BusinessToolFragment(String id)
    {
        this.modualId = id;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_business_tool,container,false);
