...
import cheetah.alphacapital.databinding.FragmentPoliciesBinding;
...
public class PoliciesFragment extends Fragment
{
    ...
    public PoliciesFragment(String id)
    {
        this.modualId = id;
    }
    ...
    {
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_policies,container,false);
    ...
    {
        binding.ivAddScheme.setOnClickListener(v -> openAddDialog(new AllLearningManualResponseModel.DataItem()));
