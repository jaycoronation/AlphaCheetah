...
import cheetah.alphacapital.databinding.FragmentEmpDarclientAnalysisBinding;
...
public class EmpDARClientAnalysisFragment extends Fragment {

    private Activity activity;
    private SessionManager sessionManager;
    private FragmentEmpDarclientAnalysisBinding binding;
    private ApiInterface apiService;

    private int employeeId,currentMonth = 0,currentYear = 0;
    private List<DARFilterResponse.DataBean.ClientWiseBean> listReport = new ArrayList<>();
    private ReportAdapter reportAdapter;

    public static Handler handler;

    @SuppressLint("ValidFragment")
    public EmpDARClientAnalysisFragment(int employeeId, int currentMonth, int currentYear) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_emp_darclient_analysis, container, false);
    ...
    private void initViews() {
        binding.noData.tvNoDataText.setText("Sorry, we couldn't find Client Analysis data.");
                    ...
                    .enqueue(new Callback<DARFilterResponse>() {
                        ...
                        public void onResponse(Call<DARFilterResponse> call, Response<DARFilterResponse> response) {
                            if(response.isSuccessful())
                            {
                                ...
                                {
                                    listReport = response.body().getData().getClient_wise();
    ...
    public double sumHours() {
        ...
        for (DARFilterResponse.DataBean.ClientWiseBean bean: listReport)
    ...
    private class ReportAdapter extends RecyclerView.Adapter<ReportAdapter.ViewHolder>{
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            DARFilterResponse.DataBean.ClientWiseBean bean = listReport.get(position);
