 ...
 */
public class ClientListResponse implements Parcelable, Serializable
{
    ...
    protected ClientListResponse(Parcel in)
    {
    ...
    public static final Creator<ClientListResponse> CREATOR = new Creator<ClientListResponse>()
    {
        @Override
        public ClientListResponse createFromParcel(Parcel in)
        {
            return new ClientListResponse(in);
        }

        @Override
        public ClientListResponse[] newArray(int size)
        {
            return new ClientListResponse[size];
        }
    };
